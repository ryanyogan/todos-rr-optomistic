  ...
  return (
    <details ref={detailsRef} className="group relative cursor-pointer">
      <summary
        ...
        tabIndex={0}
        className="flex w-28 rounded-md dark:text-zinc-300 items-center justify-between border border-gray-200 bg-gray-50 px-4 py-2 transition hover:border-gray-500 group-open:before:fixed group-open:before:inset-0 group-open:before:cursor-auto dark:border-gray-700 dark:bg-slate-800 [&::-webkit-details-marker]:hidden"
      >
      ...
      <Form
        ...
        className="absolute right-0 top-full z-50 mt-2 w-36 dark:text-slate-500 overflow-hidden rounded-md border border-gray-200 bg-gray-50 py-1 text-sm font-semibold shadow-lg ring-1 ring-slate-900/10 dark:border-gray-700 dark:bg-gray-900 dark:ring-0"
      >
        <input
          type="hidden"
          name="returnTo"
        ...
        {[
          ...
          <button
            ...
            className={`flex w-full items-center px-4 py-2 transition  hover:bg-gray-200 dark:hover:bg-gray-700 ${
              option.name === theme ? "text-sky-500 dark:text-sky-400" : ""
            }`}
          >
